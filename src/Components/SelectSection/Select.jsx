...
import OptionVisible from './OptionVisible';
...
function Select() {
	...
	return (
		<div>
			<OptionVisible
				isSelectBoxOneVisible={isSelectBoxOneVisible}
				StSelectBoxChild={StSelectBoxChild}
				StSelectBoxParent={StSelectBoxParent}
